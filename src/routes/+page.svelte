...
{#if showContent1}
	<div class="flex justify-between gap-4 p-8 pt-28 pb-2" in:fade>
		<h1 class="text-lg font-semibold">John Doeloper</h1>
		<div class="flex justify-center space-x-4">
			<a
				href="https://www.linkedin.com/in/johndoeloper"
			...
			<a
				href="https://github.com/johndoeloper"
				class="tooltip text-secondary hover:text-accent"
				target="_blank"
				data-tip="github"
			...
			<a
				href="https://www.instagram.com/johndoeloper"
				class="tooltip text-secondary hover:text-accent"
				target="_blank"
				data-tip="instagram"
			...
			<a
				href="mailto:johndoeloper@gmail.com"
				class="tooltip text-secondary hover:text-accent"
				target="_blank"
				data-tip="email"
...
{#if showContent2}
	<p class="mb-8 px-8" in:fade>
		Code wizard by day, bug creator by night. I turn coffee into code and occasionally make
		computers do cool things.
	</p>
{/if}
